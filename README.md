...
The rest of the skill runs.
  ...
  | `python3` (standard library only)                                                                                                          | [`audit:blindspot`](./audit/blindspot/), [`audit:walkthrough`](./audit/walkthrough/), [`audit:mcp-adversary`](./audit/mcp-adversary/) | Reviewer scan (`scan-reviewers.py`), the L2 OpenRouter verdict call (`openrouter-verdict.py`), and MCP server discovery                                                                  |
